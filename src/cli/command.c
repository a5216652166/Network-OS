...
{
  printf ("%s version %s\n", progname, NETWORKOS_VERSION);
  printf ("Copyright (C) 2013, NetworkOS team %s\n");
}
...
DEFUN (show_version,
       ...
       "show version",
       SHOW_STR
       "Displays NetworkOS version\n")
{
  vty_out (vty, "NetworkOS %s %s", NETWORKOS_VERSION, VTY_NEWLINE);
  vty_out (vty, "Copyright (C) 2013, NetworkOS team %s", VTY_NEWLINE);
